...
// 反序列化Job
func UnpackJob(value []byte) (ret *ScheduleJob, err error) {
	var (
		job *ScheduleJob
	)
...
func BuildJobEvent(eventType int, job *ScheduleJob) (jobEvent *JobEvent) {
	return &JobEvent{
		EventType: eventType,
		Job: job,
	}
